...
(cl:in-package arm_movement-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveLinear-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveLinear-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_movement-srv:<MoveLinear-request> is deprecated: use arm_movement-srv:MoveLinear-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <MoveLinear-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_movement-srv:command-val is deprecated.  Use arm_movement-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveLinear-request>)))
  ...
  "arm_movement/MoveLinearRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveLinear-request)))
  "Returns string type for a service object of type 'MoveLinear-request"
  "arm_movement/MoveLinearRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MoveLinear-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveLinear-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_movement-srv:<MoveLinear-response> is deprecated: use arm_movement-srv:MoveLinear-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <MoveLinear-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_movement-srv:success-val is deprecated.  Use arm_movement-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <MoveLinear-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_movement-srv:message-val is deprecated.  Use arm_movement-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveLinear-response>)))
  ...
  "arm_movement/MoveLinearResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveLinear-response)))
  "Returns string type for a service object of type 'MoveLinear-response"
  "arm_movement/MoveLinearResponse")
